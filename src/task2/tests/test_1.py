...
def test_screenshot(driver):
    ...
    element = WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.CSS_SELECTOR, '.desktop-impact-items-F7T6E')))
    element_full = driver.find_element(By.CSS_SELECTOR, '.desktop-impact-items-F7T6E')
    ActionChains(driver).move_to_element(element).perform()
    elements = driver.find_elements(By.CSS_SELECTOR, '.desktop-impact-item-eeQO3')
